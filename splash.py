...
class Generate_otp(Tk):
    ...
    def Labels(self):
        ...
        self.j = Label(self.upper_frame, text="Credit Card Fraud Prevention", font = "TimesNewRoman 38 bold",bg= "#3d3d5c", fg="white").place(x= 230, y= 35)

    def Buttons(self):
        self.GenerateOTP=PhotoImage(file = "start.png")
        self.generatebutton = Button(self , image=self.GenerateOTP, command = self.Open, border = 0 )
        self.generatebutton.place(x = 360 ,y = 250)
