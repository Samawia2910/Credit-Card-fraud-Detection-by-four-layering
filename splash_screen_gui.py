...
Frame(w, width=427, height=250, bg='#3d3d5c').place(x=0,y=0)
label1=Label(w, text='CreditCard Fraud Detection', fg='white', bg='#3d3d5c') #decorate it 
label1.configure(font=("Game Of Squids", 14, "bold"))   #You need to install this font in your PC or try another one
label1.place(x=80,y=90)

label2=Label(w, text='Loading...', fg='white', bg='#3d3d5c') #decorate it 
